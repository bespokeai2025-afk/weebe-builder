      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 min-w-0 relative">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 z-30 flex h-12 w-4 items-center justify-center rounded-sm border border-white/[0.15] bg-white/[0.05] text-white/60 hover:text-white/90 hover:bg-white/[0.12] hover:border-white/[0.25] transition-all duration-200"
          >
            {leftOpen
