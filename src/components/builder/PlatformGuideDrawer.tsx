  ...
  return (
    <div className="border border-border rounded-lg overflow-hidden">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-3 py-2.5 bg-muted/60 hover:bg-muted transition-colors text-left"
      >
    ...
    >
      ...
      <div ref={innerRef} className="w-[320px] h-full flex flex-col">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800 bg-[#0b0d12] sticky top-0 z-10 shrink-0">
          ...
          <button
            onClick={onClose}
            className="flex items-center justify-center h-5 w-5 rounded text-slate-500 hover:text-white hover:bg-muted transition-colors"
