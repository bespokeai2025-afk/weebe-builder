  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[88vh] flex-col gap-0 overflow-hidden p-0 sm:max-w-xl">
                ...
                <button
                  ...
                  className={
                    startSpeaker === value
                      ...
                      : "rounded-lg border border-border bg-muted/40 px-3 py-2 text-left hover:bg-muted"
                  }
                >
              ...
              {grouped.map(({ group, items }) => (
                <div key={group} className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                    {items.map((field) => (
                      <label key={field.name} className="block rounded-lg border border-border bg-muted/40 p-2">
        ...
        <DialogFooter className="gap-2 border-t border-border px-5 py-3 sm:justify-between">
