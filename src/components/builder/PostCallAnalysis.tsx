  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex flex-wrap gap-1">
        ...
        {data.sentiment && (
          <span className={`inline-flex items-center rounded-full px-1.5 py-px text-[9px] font-medium border border-border bg-muted ${sentimentColor}`}>
      ...
      {hasVariables && (
        <div className="rounded border border-border bg-muted/40 overflow-hidden">
          <p className="text-[9px] uppercase tracking-wider text-muted-foreground/60 font-semibold px-2 pt-1.5 pb-1 border-b border-border/60">
            Variables
          </p>
