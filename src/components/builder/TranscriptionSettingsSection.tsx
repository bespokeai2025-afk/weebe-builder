  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <input
          type="text"
          className="w-full rounded-md border border-border dark:border-white/[0.08] bg-muted/60 dark:bg-white/[0.03] px-2.5 py-1.5 text-[11px] text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50"
