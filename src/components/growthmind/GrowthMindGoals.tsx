...
function MigrationBanner({ sql }: { sql: string }) {
  ...
  return (
    <div className="rounded-xl border border-amber-500/20 bg-amber-500/[0.06] p-5">
      ...
      <pre className="rounded-lg bg-black/40 border border-border dark:border-white/[0.06] p-3 text-[10px] text-emerald-300 font-mono overflow-x-auto whitespace-pre-wrap leading-relaxed">
        {sql}
      </pre>
...
function ProgressBar({ pct, atRisk, achieved }: { pct: number; atRisk: boolean; achieved: boolean }) {
  ...
  return (
    <div className="relative h-2 w-full rounded-full bg-muted dark:bg-white/[0.06] overflow-hidden">
      <div
...
function GoalCard({
  ...
  return (
    ...
    >
      ...
      {/* AI commentary */}
      <div className="flex items-start gap-2 rounded-lg bg-muted/60 dark:bg-white/[0.03] border border-border dark:border-white/[0.05] px-3 py-2.5">
      ...
      <div className="mt-2.5">
        <span className="rounded-full bg-muted dark:bg-white/[0.04] border border-border dark:border-white/[0.06] px-2 py-0.5 text-[10px] text-muted-foreground">
  ...
  return (
    <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/[0.04] p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={onCancel} className="rounded-md p-1 text-muted-foreground hover:text-foreground hover:bg-muted dark:hover:bg-white/[0.05] transition-colors">
          <X className="h-4 w-4" />
        </button>
      </div>
              ...
              <button
                ...
                className={cn(
                  ...
                  metric === m.key
                    ...
                    : "border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] text-muted-foreground hover:text-foreground hover:bg-muted dark:hover:bg-white/[0.04]",
                )}
              >
  ...
  return (
    <div className="grid grid-cols-3 gap-3 mb-6">
      {[
        ...
        <div key={label} className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60 px-4 py-3 flex items-center gap-3">
