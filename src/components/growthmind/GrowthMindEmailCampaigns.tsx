...
function AiDraftModal({
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg rounded-2xl border border-border bg-[#0f1117] shadow-2xl overflow-hidden">
  ...
  return (
    <>
      <div
        ...
        onClick={e => { if (e.target === e.currentTarget) onClose(); }}
      >
        <div className="w-full max-w-2xl max-h-[90vh] flex flex-col rounded-2xl border border-border bg-[#0f1117] shadow-2xl overflow-hidden">
      ...
      {isLoading ? (
        ...
        <div className="space-y-2">
          {campaigns.map(c => (
            <div
              key={c.id}
              className="group flex items-center gap-3 rounded-xl border border-border bg-card/40 p-4 hover:border-foreground/20 transition-all"
            >
...
function AddWarmupModal({ onClose, onAdded }: { onClose: () => void; onAdded: (w: DomainWarmup) => void }) {
  ...
  return (
    <div
      ...
      onClick={e => { if (e.target === e.currentTarget) onClose(); }}
    >
      <div className="w-full max-w-md rounded-2xl border border-border bg-[#0f1117] shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-border">
          <div className="flex items-center gap-2">
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          <div className="rounded-xl border border-border bg-muted/40 p-3 text-xs text-muted-foreground/70 space-y-1">
  ...
  return (
    <div className="rounded-xl border border-border bg-card/40 overflow-hidden">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-2 border-t border-border/60 text-xs text-muted-foreground/50 hover:text-muted-foreground transition-colors"
      >
  ...
  return (
    <div className="space-y-5">
      {isLoading ? (
        ...
        <>
          <div className="rounded-xl border border-border bg-card/40 p-5 flex items-center gap-5">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {(data?.statuses ?? []).map(s => {
                  ...
                  return (
                    <div key={s.status} className="rounded-xl border border-border bg-card/30 p-3 space-y-1.5">
                      <div className="flex items-center justify-between">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {(data?.tags ?? []).map(t => (
                  <div
                    key={t.tag}
                    className="flex items-center gap-1.5 rounded-full border border-border bg-muted/60 px-2.5 py-1 text-xs"
                  >
