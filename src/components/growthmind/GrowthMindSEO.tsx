...
function CsvImportModal({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl max-h-[90vh] flex flex-col rounded-2xl border border-border bg-[#0f1117] shadow-2xl overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          <div
            ...
            className={cn(
              ...
              dragging ? "border-emerald-400/60 bg-emerald-400/[0.04]" : "border-border hover:border-foreground/25",
            )}
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              rows={5}
              className="w-full rounded-lg border border-border bg-muted/60 px-3 py-2 text-xs font-mono resize-none focus:outline-none focus:border-emerald-500/40 placeholder:text-muted-foreground/40"
                  ...
                  return (
                    <div key={field} className="flex flex-col gap-1">
                      ...
                      <select
                        ...
                        className="w-full rounded-md border border-border bg-[#0f1117] px-2 py-1 text-[11px] text-foreground focus:outline-none focus:border-emerald-500/40 appearance-none cursor-pointer"
                      >
                        {!isRequired && (
                    ...
                    {parsed.slice(0, 200).map((row, i) => {
                      ...
                      return (
                        <tr
                          ...
                          className={cn(
                            "transition-colors",
                            isDupe && skipDupes ? "opacity-40 line-through" : "hover:bg-muted/40",
                          )}
                        >
        ...
        {/* Footer */}
        <div className="flex items-center justify-between gap-3 px-5 py-4 border-t border-border shrink-0 bg-[#0f1117]">
                      ...
                      return (
                        <tr
                          ...
                          className={cn(
                            ...
                            checked ? "bg-blue-500/[0.06]" : "hover:bg-muted/40",
...
function ContentIdeaRow({
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3 group hover:bg-muted/40 transition-colors border-b border-border/60 last:border-0">
...
function WebsiteArchitectureCard({ siteUrl }: { siteUrl: string }) {
  ...
  if (isLoading || !arch) {
    return (
      <div className="rounded-xl border border-border bg-card/60 p-5 text-xs text-muted-foreground flex items-center gap-2">
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      {showPropertyPicker && (
        ...
        >
          <div className="w-full max-w-sm rounded-2xl border border-border bg-[#0f1117] shadow-2xl overflow-hidden">
  ...
  return (
    <div className="space-y-5">
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {briefs.map(b => (
            <div key={b.id} className="rounded-xl border border-border bg-card/40 overflow-hidden">
              <div className="flex items-start gap-3 p-4">
                <div className="flex-1 min-w-0">
                  ...
                  {b.targetKws.length > 0 && (
                    <div className="flex flex-wrap gap-1 mt-1.5">
                      {b.targetKws.map(k => (
                        <span key={k} className="rounded-full border border-border bg-muted/60 px-2 py-0.5 text-[10px] text-muted-foreground/60">{k}</span>
                      ))}
                    </div>
                  )}
                </div>
                <div className="flex items-center gap-1.5 shrink-0">
                  <button
                    ...
                    className="rounded-lg border border-border bg-muted/40 p-1.5 text-muted-foreground hover:text-foreground transition-colors"
                    title="View brief"
                  >
                  ...
                  <button
                    ...
                    className="rounded-lg border border-border bg-muted/40 p-1.5 text-muted-foreground hover:text-red-400 transition-colors"
                  >
...
function ContentGapSection() {
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-xl border border-border bg-card/60 p-5 flex items-center justify-between gap-3">
        <div>
          ...
          <div>
            ...
            <div className="space-y-2.5">
              {result.gaps.map((gap, i) => (
                <div key={i} className="rounded-xl border border-border bg-card/40 p-4 space-y-2.5">
  ...
  function CopyButton({ value, id }: { value: string; id: string }) {
    return (
      <button
        ...
        className="rounded border border-border p-1 text-muted-foreground/60 hover:text-foreground transition-colors"
        title="Copy"
      >
  ...
  function ResultField({ label, value, id, mono }: { label: string; value: string; id: string; mono?: boolean }) {
    ...
    return (
      <div className="space-y-1.5">
        ...
        <p className={cn("text-xs rounded-lg bg-muted/40 border border-border px-3 py-2", mono && "font-mono text-[11px]")}>{value}</p>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full h-8 rounded-lg border border-border bg-muted/60 px-3 text-xs focus:outline-none focus:border-emerald-500/40"
            >
        ...
        <div className="rounded-xl border border-border bg-card/40 p-5 space-y-4">
          ...
          {result.schema && (
            <div className="space-y-1.5">
              ...
              <pre className="text-[10px] font-mono rounded-lg bg-muted/40 border border-border px-3 py-2 overflow-x-auto text-muted-foreground/60 whitespace-pre-wrap">{result.schema}</pre>
            </div>
          )}
        </div>
      )}
              ...
              <>
                ...
                <div className="rounded-xl border border-border bg-card/60 overflow-hidden">
                  ...
                  {aiSuggestedIdeas.filter(i => !dismissedAiIdeaIds.has(i.id)).length > 0 && (
                    <div className="px-4 py-3 border-b border-border bg-emerald-500/[0.03] space-y-2">
