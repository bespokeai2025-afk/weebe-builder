    ...
    <div className="group rounded-xl border border-border dark:border-white/[0.06] bg-card/60 p-4 flex flex-col gap-3 hover:border-foreground/20 dark:hover:border-white/[0.12] transition-all">
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="shrink-0 flex h-7 w-7 items-center justify-center rounded-lg bg-muted dark:bg-white/[0.04] border border-border dark:border-white/[0.06]">
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <div className="relative">
            ...
            {menu && (
              <div className="absolute right-0 top-6 z-10 w-40 rounded-lg border border-border dark:border-white/[0.08] bg-popover shadow-xl py-1">
                <button onClick={() => { onView(asset); setMenu(false); }}
                  className="w-full flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-muted dark:hover:bg-white/[0.04] transition-colors">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-muted dark:hover:bg-white/[0.04] transition-colors text-violet-400">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-muted dark:hover:bg-white/[0.04] transition-colors text-orange-400">
                ...
                {asset.status !== "archived" && (
                  <button onClick={() => { onStatusChange(asset.id, "archived"); setMenu(false); }}
                    className="w-full flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-muted dark:hover:bg-white/[0.04] transition-colors text-muted-foreground">
                    <Archive className="h-3 w-3" /> Archive
                  </button>
                )}
                <div className="border-t border-border dark:border-white/[0.06] my-1" />
                <button onClick={() => { onDelete(asset.id); setMenu(false); }}
                  className="w-full flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-muted dark:hover:bg-white/[0.04] text-red-400 transition-colors">
...
function MetaConnectModal({ onClose, onSaved }: {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-background/70 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-2xl border border-border dark:border-white/[0.08] bg-[hsl(var(--sidebar-background))] shadow-2xl p-6 space-y-5">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/[0.04] p-4 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                <div className="rounded-lg bg-muted/60 dark:bg-white/[0.03] border border-border dark:border-white/[0.06] px-3 py-2">
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-stretch bg-background/80 backdrop-blur-sm">
        <div className="ml-auto flex w-full max-w-3xl flex-col border-l border-border dark:border-white/[0.08] bg-[hsl(var(--sidebar-background))] overflow-hidden">
          {/* Header */}
          <div className="flex items-center gap-3 px-5 py-3.5 border-b border-border dark:border-white/[0.06] shrink-0">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <button onClick={() => copy(content)} className="p-1.5 rounded hover:bg-muted dark:hover:bg-white/[0.04] transition-colors text-muted-foreground hover:text-foreground" title="Copy content">
          ...
          {isAd && (
            <div className="flex items-center gap-2 px-5 py-3 border-b border-border dark:border-white/[0.06] shrink-0 bg-muted/20 dark:bg-white/[0.01]">
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4">
            <textarea
              ...
              className="w-full rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] px-4 py-3 text-sm leading-relaxed text-foreground focus:outline-none focus:ring-1 focus:ring-ring resize-none min-h-[400px] font-mono"
              style={{ height: "auto" }}
    ...
    <div className="px-6 py-5 max-w-5xl">
      <div className="flex items-center gap-4 mb-5">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <button onClick={prevMonth} className="p-1 rounded hover:bg-muted dark:hover:bg-white/[0.04] transition-colors text-muted-foreground">
            <ChevronLeft className="h-4 w-4" />
          </button>
          <span className="text-sm font-semibold w-36 text-center">{MONTH_NAMES[month]} {year}</span>
          <button onClick={nextMonth} className="p-1 rounded hover:bg-muted dark:hover:bg-white/[0.04] transition-colors text-muted-foreground">
            <ChevronRight className="h-4 w-4" />
          </button>
        </div>
      </div>

      <div className="rounded-xl border border-border dark:border-white/[0.06] overflow-hidden">
        {/* Day headers */}
        <div className="grid grid-cols-7 border-b border-border dark:border-white/[0.06]">
          {DAY_NAMES.map(d => (
          ...
          {cells.map((day, idx) => {
            ...
            return (
              <div
                key={idx}
                className={cn(
                  "min-h-[80px] p-1.5 border-b border-r border-border/60 dark:border-white/[0.04] last:border-r-0",
                  idx % 7 === 6 && "border-r-0",
                  !day && "bg-muted/20 dark:bg-white/[0.01]",
                )}
              >
                {day && (
                  <>
            ...
            {([
              ...
              >
                ...
                {t.id === "library" && statsData && statsData.total > 0 && (
                  <span className="ml-0.5 rounded-full bg-muted dark:bg-white/[0.08] px-1.5 py-0.5 text-[9px] font-semibold">{statsData.total}</span>
                )}
              </button>
            ))}
          </div>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto">
                                  ...
                                  <button
                                    ...
                                    className={cn(
                                      ...
                                      active
                                        ...
                                        : "border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] text-muted-foreground hover:border-foreground/20 dark:hover:border-white/[0.12] hover:text-foreground",
                                    )}
                                  >
                        ...
                        <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60 p-4 space-y-3">
                            ...
                            <button
                              ...
                              className={cn(
                                ...
                                aiMode === "smart"
                                  ...
                                  : "bg-muted/40 dark:bg-white/[0.02] border-border dark:border-white/[0.06] text-muted-foreground hover:text-foreground",
                              )}
                            >
                          ...
                          {aiMode === "smart" && (
                            <div className="flex items-center gap-2 text-xs">
                              ...
                              <span className={cn(
                                ...
                                smartMeta.tier === "premium" ? "bg-amber-500/15 text-amber-300" : "bg-muted dark:bg-white/[0.06] text-muted-foreground",
                              )}>{smartMeta.tier}</span>
                            </div>
                          )}
                          ...
                          {aiMode === "manual" && (
                            <div className="space-y-3">
                              ...
                              {manualMeta && (
                                <div className="rounded-lg bg-muted/40 dark:bg-white/[0.02] border border-border/60 dark:border-white/[0.04] px-3 py-2 grid grid-cols-4 gap-2 text-xs">
                                  <div>
                  ...
                  {selectedType && (
                    <div>
                      ...
                      <div className="flex items-center gap-3 mb-3 flex-wrap">
                        ...
                        <div className="flex items-center gap-1 rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-0.5 ml-auto">
                          <button
          ...
          {tab === "library" && (
            <div className="flex h-full min-h-[600px]">
              {/* Filter sidebar */}
              <aside className="w-44 shrink-0 border-r border-border dark:border-white/[0.06] py-4 overflow-y-auto">
