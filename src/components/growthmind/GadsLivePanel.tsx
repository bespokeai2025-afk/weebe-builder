...
function ConversionUploadStatus() {
  ...
  return (
    <div className="px-4 py-3 border-t border-border dark:border-white/[0.05]">
...
export function GadsLivePanel({ onConnectClick }: { onConnectClick: () => void }) {
  ...
  if (connLoading) {
    return (
      <div className="border-t border-border dark:border-white/[0.06] px-4 py-6 flex items-center gap-2 text-muted-foreground">
  ...
  return (
    <div className="border-t border-border dark:border-white/[0.06]">
      ...
      {/* ── 4-stage status ── */}
      <div className="px-4 py-3 bg-muted/25 dark:bg-white/[0.015]">
            ...
            <div className="space-y-1.5">
              {selectable.map((c: any) => (
                <button key={c.customerId}
                  className="w-full flex items-center gap-3 rounded-lg border border-border dark:border-white/[0.08] bg-muted/40 dark:bg-white/[0.02] px-3 py-2 hover:border-blue-500/30 transition-colors text-left"
      ...
      {showDashboard && (
        <>
          ...
          <div className="px-4 py-2.5 border-t border-border dark:border-white/[0.05] flex items-center gap-2 flex-wrap">
          ...
          {dashLoading ? (
            ...
            <>
              {/* KPI row */}
              <div className="px-4 py-3 grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-3 border-t border-border/60 dark:border-white/[0.04]">
                {[
              ...
              <div className="border-t border-border/60 dark:border-white/[0.04]">
                        ...
                        {visibleCampaigns.map((c: any) => (
                          <Fragment key={c.campaignId}>
                            ...
                            {expandedCampaign === c.campaignId && (
                              <tr>
                                <td colSpan={9} className="px-4 py-3 bg-muted/25 dark:bg-white/[0.015]">
                                  {detailLoading ? (
                                    ...
                                    <div className="space-y-3">
                                      ...
                                      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                                        {Object.entries(campDetail.dimensions ?? {}).map(([dim, rows]: [string, any]) => (
                                          <div key={dim} className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/20 dark:bg-white/[0.01] p-2.5">
              ...
              {recommendations.length > 0 && (
                <div className="border-t border-border dark:border-white/[0.05] px-4 py-3">
                  ...
                  <div className="space-y-1.5">
                    {changeRequests.slice(0, 8).map((cr: any) => {
                      ...
                      const tone =
                        ...
                        "text-muted-foreground border-border dark:border-white/[0.08] bg-muted/40 dark:bg-white/[0.02]";
                      const label =
              ...
              {/* Sync history */}
              <div className="border-t border-border dark:border-white/[0.05] px-4 py-2.5">
            ...
            <p className="px-4 py-4 text-xs text-muted-foreground border-t border-border/60 dark:border-white/[0.04]">
