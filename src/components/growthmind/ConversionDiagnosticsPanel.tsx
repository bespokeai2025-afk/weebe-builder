...
const SIGNAL_META: Record<string, { label: string; cls: string; Icon: typeof CheckCircle2 }> = {
  ...
  unavailable: { label: "Unavailable", cls: "text-muted-foreground border-border dark:border-white/[0.1] bg-muted/60 dark:bg-white/[0.03]", Icon: HelpCircle },
};
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-4 space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-2 text-[11px]">
        <Badge variant="outline" className="text-[10px] border-border dark:border-white/[0.1] bg-muted/60 dark:bg-white/[0.03] text-muted-foreground">
          ...
          <table className="w-full text-[11px]">
            ...
            <tbody>
              {data.conversions.map((c: any) => (
                <tr key={c.conversionName} className="border-t border-border/60 dark:border-white/[0.04]">
