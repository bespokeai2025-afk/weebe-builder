    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center h-full gap-3 p-6 text-center">
          ...
          <button
            className="text-xs px-3 py-1.5 rounded-lg bg-muted dark:bg-white/[0.05] hover:bg-muted dark:hover:bg-white/[0.08] transition-colors"
  ...
  return (
    <ReactMarkdown
      components={{
        ...
        code:   ({ children }) => <code className="bg-muted dark:bg-white/[0.06] rounded px-1 py-0.5 text-[11px]">{children}</code>,
      }}
    >
      {content}
    </ReactMarkdown>
  ...
  return (
    <div className="border border-border dark:border-white/[0.06] rounded-xl overflow-hidden">
      <button
        type="button"
        onClick={() => setOpen(v => !v)}
        className="w-full flex items-center justify-between px-4 py-3 bg-muted/40 dark:bg-white/[0.02] hover:bg-muted dark:hover:bg-white/[0.04] transition-colors"
      >
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 shrink-0 flex-wrap justify-end">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs bg-muted dark:bg-white/[0.05] hover:bg-muted dark:hover:bg-white/[0.08] text-muted-foreground transition-colors disabled:opacity-50"
          >
        ...
        <div className="rounded-xl border border-blue-500/20 bg-blue-500/[0.04] p-4 space-y-3">
          ...
          {(
            ...
            <div key={field}>
              ...
              <input
                className="w-full bg-black/20 border border-border dark:border-white/[0.08] rounded-lg px-3 py-2 text-xs text-foreground focus:outline-none focus:border-blue-500/50"
          ...
          <div>
            ...
            <textarea
              rows={3}
              className="w-full bg-black/20 border border-border dark:border-white/[0.08] rounded-lg px-3 py-2 text-xs text-foreground focus:outline-none focus:border-blue-500/50 resize-none"
          ...
          <div className="flex justify-end gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-xs text-muted-foreground hover:bg-muted dark:hover:bg-white/[0.05] transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              {Object.keys(strategy.serviceScores).length > 0 && (
                <div className="flex flex-wrap gap-1.5 mt-2">
                  {Object.entries(strategy.serviceScores)
                    ...
                    .slice(0, 5)
                    .map(([name, score]) => (
                      <span key={name} className="text-[10px] px-2 py-0.5 rounded-full bg-muted dark:bg-white/[0.06] text-muted-foreground">
      ...
      <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-4">
        {[
          ...
          <div key={label} className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-3">
      ...
      {strategy.kpis.length > 0 && (
        <div className="rounded-xl border border-border dark:border-white/[0.06] overflow-hidden">
          <div className="px-4 py-3 bg-muted/40 dark:bg-white/[0.02] flex items-center gap-2">
          ...
          <div className="p-3 grid grid-cols-2 gap-2 sm:grid-cols-3">
            {strategy.kpis.map((kpi, i) => (
              <div key={i} className="rounded-lg bg-muted/60 dark:bg-white/[0.03] px-3 py-2.5">
      ...
      {(strategy.requiredAssets.length > 0 || strategy.approvalActions.length > 0) && (
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          {strategy.requiredAssets.length > 0 && (
            <div className="rounded-xl border border-border dark:border-white/[0.06] p-4">
        ...
        <div className="rounded-xl border border-border dark:border-white/[0.06] p-4">
          ...
          <div className="flex flex-wrap gap-2">
            {strategy.promptEnginesUsed.map(engine => {
              ...
              return (
                <div key={engine} className="flex items-center gap-1.5 rounded-lg bg-muted dark:bg-white/[0.04] border border-border dark:border-white/[0.06] px-2.5 py-1.5">
                ...
                <div
                  ...
                  className={cn(
                    "flex items-start gap-3 px-3 py-2.5 rounded-lg border transition-colors",
                      ...
                      : "bg-muted/40 dark:bg-white/[0.02] border-border/60 dark:border-white/[0.04]",
                  )}
                >
                  <button
                    type="button"
                  ...
                  <div className="flex items-center gap-1.5 shrink-0 mt-0.5">
                    {task.channel && (
                      <span className="text-[9px] px-1.5 py-0.5 rounded bg-muted dark:bg-white/[0.05] text-muted-foreground/60 uppercase tracking-widest">{task.channel}</span>
                    )}
                    <span className={cn(
                      "text-[9px] px-1.5 py-0.5 rounded font-semibold uppercase tracking-widest",
                      task.priority === "high"   ? "bg-red-500/10 text-red-400"
                      : task.priority === "medium" ? "bg-yellow-500/10 text-yellow-400"
                      : "bg-muted dark:bg-white/[0.05] text-muted-foreground/60",
                    )}>
                      {task.priority}
                    </span>
                  </div>
  ...
  return (
    <GrowthMindShell>
      <div className="flex min-h-0 flex-1">
        ...
        <aside className="w-72 shrink-0 border-r border-border/60 dark:border-white/[0.04] flex flex-col min-h-0">
          {/* Type selector */}
          <div className="p-3 border-b border-border/60 dark:border-white/[0.04]">
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            isActive
                              ...
                              : "hover:bg-muted dark:hover:bg-white/[0.04] text-muted-foreground hover:text-foreground",
                          )}
                        >
            ...
            <div className="mt-3 space-y-2">
              <div>
                ...
                <input
                  className="w-full bg-black/20 border border-border dark:border-white/[0.08] rounded-lg px-2.5 py-1.5 text-xs text-foreground placeholder:text-muted-foreground/40 focus:outline-none focus:border-emerald-500/40 transition-colors"
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive ? "bg-muted dark:bg-white/[0.06]" : "hover:bg-muted/60 dark:hover:bg-white/[0.03]",
                      )}
                    >
                      <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col items-center justify-center h-full gap-6">
              ...
              <div className="grid grid-cols-3 gap-3 max-w-md w-full">
                {[
                  ...
                  <div key={label} className="rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-3 text-center">
