...
function CompetitorCard({
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60 overflow-hidden">
      {/* Header */}
      <div
        className="flex items-center gap-3 px-4 py-3 cursor-pointer hover:bg-muted/40 dark:hover:bg-white/[0.02] transition-colors"
        onClick={() => setOpen(v => !v)}
      >
        <div className="flex h-8 w-8 items-center justify-center rounded-md bg-muted dark:bg-white/[0.05] shrink-0">
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            {competitors.length === 0 && !showForm ? (
              <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60 px-6 py-16 text-center">
