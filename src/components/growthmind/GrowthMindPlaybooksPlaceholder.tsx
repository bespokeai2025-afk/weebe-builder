...
export function GrowthMindPlaybooksPlaceholder() {
  return (
    <GrowthMindShell>
      <div className="flex flex-col items-center justify-center h-full min-h-[480px] gap-4 px-6 py-12 text-center">
        ...
        <div>
          ...
          <h2 className="text-lg font-semibold mb-1.5">Industry Playbooks</h2>
          <p className="text-sm text-muted-foreground max-w-sm leading-relaxed">
            Ready-made marketing playbooks for Real Estate, Mortgage, Dental, Solar, SaaS, and more — with calling, email, WhatsApp, and follow-up sequences.
          </p>
        </div>
      </div>
    </GrowthMindShell>
