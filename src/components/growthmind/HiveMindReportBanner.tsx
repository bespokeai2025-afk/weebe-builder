...
export function HiveMindReportBanner({
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/40 mb-6 overflow-hidden">

      {/* Top bar */}
      <div className="px-4 py-2.5 border-b border-border/60 dark:border-white/[0.04] flex items-center justify-between gap-3 flex-wrap">
