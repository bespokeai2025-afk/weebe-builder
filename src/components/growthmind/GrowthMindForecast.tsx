  ...
  return (
    <div className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] overflow-hidden">
      ...
      {open && s.leadsBase !== undefined && (
        <div className="px-4 pb-3 pt-1 border-t border-border/60 dark:border-white/[0.04]">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <div key={item.label} className="rounded-md bg-muted/60 dark:bg-white/[0.03] px-3 py-2">
...
function CustomTooltip({ active, payload, label, metric }: any) {
  ...
  return (
    <div className="rounded-lg border border-border dark:border-white/[0.12] bg-[hsl(var(--card))] px-3 py-2.5 text-xs shadow-xl">
  ...
  return (
    <GrowthMindShell>
      <div className="px-6 py-5 max-w-5xl">
        ...
        {/* Config panel */}
        {showConfig && (
          <div className="mb-5 rounded-xl border border-border dark:border-white/[0.06] bg-card/60 p-4">
        ...
        {isLoading ? (
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap">
              {/* Metric tabs */}
              <div className="flex gap-1 p-1 rounded-lg bg-muted dark:bg-white/[0.04] border border-border dark:border-white/[0.06]">
