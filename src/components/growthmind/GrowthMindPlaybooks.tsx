  ...
  return (
    <div className={cn(
      ...
      isActive
        ...
        : "border-border dark:border-white/[0.06] hover:border-foreground/20 dark:hover:border-white/[0.1]",
    )}>
      {/* Header */}
      <div className="p-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className={cn(
              ...
              isActive ? "bg-emerald-500/20 ring-1 ring-emerald-500/30" : "bg-muted dark:bg-white/[0.05]",
            )}>
              <PlaybookIcon
        ...
        <div className="flex flex-wrap gap-1.5 mt-3">
          {playbook.sections.map(s => (
            <span
              key={s.channel}
              className="inline-flex items-center gap-1 rounded-md bg-muted dark:bg-white/[0.04] px-2 py-0.5 text-[10px] text-muted-foreground border border-border dark:border-white/[0.06]"
            >
