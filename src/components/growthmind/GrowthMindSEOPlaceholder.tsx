...
export function GrowthMindSEOPlaceholder() {
  return (
    <GrowthMindShell>
      <div className="flex flex-col items-center justify-center h-full min-h-[480px] gap-4 px-6 py-12 text-center">
        ...
        <div>
          ...
          <h2 className="text-lg font-semibold mb-1.5">SEO Intelligence</h2>
          <p className="text-sm text-muted-foreground max-w-sm leading-relaxed">
            Connect your website, track keyword rankings, discover content opportunities, and get GrowthMind's organic growth recommendations.
          </p>
        </div>
      </div>
    </GrowthMindShell>
