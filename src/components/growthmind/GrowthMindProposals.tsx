...
function CampaignCard({ proposal, onStatusChange, busy, highlighted }: {
  ...
  return (
    <div ref={cardRef} className={cn(
      ...
      <div className="px-4 py-3.5 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-1 mt-1.5">
            ...
            {proposal.audience && (
              <span className="text-[9px] rounded border border-border bg-muted/60 text-muted-foreground px-1 py-0.5 flex items-center gap-0.5">
      ...
      <div className="border-t border-border/60 px-4 py-2.5 flex items-center justify-between gap-2 flex-wrap">
      ...
      <div className="px-4 py-3.5 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-1 mt-1.5">
            ...
            {proposal.duration && (
              <span className="text-[9px] rounded border border-border bg-muted/60 text-muted-foreground px-1 py-0.5">{proposal.duration}</span>
            )}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1">
                {proposal.creativeAngles.map((angle, i) => (
                  <span key={i} className="text-[11px] bg-muted text-muted-foreground px-2 py-0.5 rounded">{angle}</span>
                ))}
              </div>
            </div>
          )}
    ...
    <GrowthMindShell>
      <div className="px-6 py-5 max-w-3xl space-y-5">
        ...
        {isLoading ? (
          ...
          <div className="rounded-xl border border-dashed border-border bg-card/40 flex flex-col items-center justify-center py-16 gap-3 text-center px-6">
