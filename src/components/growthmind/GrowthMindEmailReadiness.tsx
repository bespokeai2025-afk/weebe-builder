...
export function GrowthMindEmailReadiness() {
  ...
  return (
    <div className="flex flex-col gap-6 p-6 max-w-4xl">
      ...
      {/* Score card */}
      <div className="rounded-xl border border-border bg-gradient-to-br from-white/[0.03] to-transparent p-6 flex flex-col sm:flex-row items-center gap-6">
        {isLoading ? (
          <div className="w-28 h-28 animate-pulse rounded-full bg-muted" />
        ) : (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {altChannels.map((ch) => (
              <Link key={ch.to} to={ch.to}
                className="group flex items-center justify-between rounded-xl border border-border bg-muted/40 p-4 hover:border-foreground/20 transition-all">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            ...
            <Link key={link.to} to={link.to}
              className="group flex items-center gap-3 rounded-xl border border-border bg-muted/40 p-3.5 hover:border-foreground/20 hover:bg-muted transition-all">
