  ...
  return (
    <label className="block">
      ...
      <div className="mt-1 flex items-center gap-2">
        <input
          type="number"
          className="w-28 rounded-md border border-border dark:border-white/10 bg-muted/30 dark:bg-white/[0.04] px-2 py-1.5 text-sm outline-none focus:border-violet-500/50 disabled:opacity-50"
          value={value ?? ""}
...
function ListField({ label, desc, value, onChange, disabled }: {
  ...
  return (
    <label className="block">
      ...
      <textarea
        rows={2}
        className="mt-1 w-full rounded-md border border-border dark:border-white/10 bg-muted/30 dark:bg-white/[0.04] px-2 py-1.5 text-sm outline-none focus:border-violet-500/50 disabled:opacity-50"
        value={value.join("\n")}
        disabled={disabled}
...
export function MarketingAutonomyCard() {
  ...
  return (
    <div className="space-y-4">
      {!canManage && (
        <div className="flex items-center gap-2 rounded-md bg-muted/30 dark:bg-white/[0.04] px-3 py-2 text-xs text-muted-foreground">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active ? cn("border-transparent ring-2", c.ring, c.bg) : "border-border dark:border-white/[0.08] hover:bg-muted/20 dark:hover:bg-white/[0.03]",
              )}
            >
      ...
      <div className="rounded-lg border border-border dark:border-white/[0.08] p-4 space-y-4">
        <div>
