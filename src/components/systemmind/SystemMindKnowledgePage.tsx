...
export function SystemMindKnowledgePage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      {/* Upload dropzone */}
      <div
        className="relative flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-border dark:border-white/[0.1] bg-muted/40 dark:bg-white/[0.02] px-8 py-12 cursor-pointer hover:border-sky-500/40 hover:bg-sky-500/[0.03] transition-colors"
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-1.5">
          {CATEGORY_SUGGESTIONS.map((cat) => (
            <Badge key={cat} variant="outline" className="text-[10px] text-muted-foreground border-border dark:border-white/[0.08]">
              {cat}
            </Badge>
          ))}
        </div>
      ...
      <div className="space-y-2">
        ...
        {!isLoading && docList.length === 0 && (
          <div className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] py-10 text-center">
        ...
        {docList.map((doc: any) => (
          <div
            key={doc.id}
            className="flex items-center gap-3 rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] px-3 py-2.5"
          >
