...
function StatusRow({ label, value }: { label: string; value: React.ReactNode }) {
  return (
    <div className="flex items-center justify-between gap-3 text-[11px] py-1 border-b border-border/60 dark:border-white/[0.04] last:border-0">
    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
        {[
          ...
          <div key={s.label} className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-2.5">
        ...
        <Section icon={Radio} title="Recent webhook events">
          <div className="space-y-1 max-h-56 overflow-auto">
            {data.recentEvents.map((e) => (
              <div key={e.id} className="flex items-center gap-2 text-[10px] py-0.5 border-b border-border/60 dark:border-white/[0.04] last:border-0">
                <span className={cn(
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <select
          className="h-8 text-xs rounded-md border border-border dark:border-white/[0.08] bg-background px-2 min-w-56"
          value={activeId ?? ""}
