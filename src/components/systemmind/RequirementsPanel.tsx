...
export function RequirementsPanel({
  ...
  return (
    <div className="space-y-4">
      {/* Detected setup */}
      {detected && (
        <div className="rounded-lg border border-border dark:border-white/[0.05] bg-muted/40 dark:bg-white/[0.02] p-3">
      ...
      <div className="space-y-2">
        ...
        {sections.map(([section, qs]) => {
          ...
          return (
            <div key={section} className="rounded-lg border border-border dark:border-white/[0.05] bg-muted/20 dark:bg-white/[0.01]">
              <button
              ...
              {open && (
                <div className="space-y-3 border-t border-border dark:border-white/[0.05] p-3">
                  {qs.map((q) => (
      ...
      {(proposed.length > 0 || decided.length > 0) && (
        <div className="space-y-2">
          ...
          {decided.map((s) => (
            <div key={s.id} className="flex items-center gap-2 rounded-lg border border-border dark:border-white/[0.05] bg-muted/20 dark:bg-white/[0.01] px-3 py-2">
      ...
      {simResults && (
        <div className="space-y-2">
          ...
          {simResults.map((r: any) => (
            <div key={r.outcome} className="rounded-lg border border-border dark:border-white/[0.05] bg-muted/20 dark:bg-white/[0.01] p-2.5">
              <div className="mb-1 flex items-center gap-2">
