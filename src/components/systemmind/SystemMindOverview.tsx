        ...
        {isLoading ? (
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="md:col-span-2 rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-5">
            ...
            {/* Workflow Health */}
            {data?.workflowHealth ? (
              <div className="rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-5">
            ...
            <div className="rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-5">
              ...
              <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                {Object.entries(summary.systemHealth).map(([key, ok]) => (
                  <div key={key} className="flex items-center gap-2 rounded-lg border border-border/60 dark:border-white/[0.04] bg-muted/40 dark:bg-white/[0.02] px-3 py-2">
              ...
              <div className="rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-5">
                ...
                <div className="space-y-2">
                  {summary.recommendedActions.map((a) => (
                    <div key={a.id} className="flex items-start gap-3 rounded-lg border border-border/60 dark:border-white/[0.04] bg-muted/40 dark:bg-white/[0.02] px-3 py-2.5">
                      <div className="min-w-0 flex-1">
