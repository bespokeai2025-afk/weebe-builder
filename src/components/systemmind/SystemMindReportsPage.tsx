        ...
        <div className="mx-auto max-w-4xl px-4 py-6 md:px-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="ml-auto flex items-center gap-2 shrink-0">
              {selected.model && (
                <span className="text-[10px] text-muted-foreground/50 bg-muted dark:bg-white/[0.04] rounded px-1.5 py-0.5">
                  {selected.model}
                </span>
              )}
          ...
          <div className="rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-6">
            <div
              className="prose prose-sm prose-invert max-w-none prose-headings:text-foreground prose-p:text-foreground/80 prose-strong:text-foreground prose-li:text-foreground/80 prose-code:text-sky-300 prose-code:bg-muted dark:bg-white/[0.06] prose-code:px-1 prose-code:rounded"
          ...
          <div className="space-y-2">
            {(reports as any[]).map((report) => (
              <button
                ...
                className="w-full text-left rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] px-4 py-3 flex items-center gap-3 hover:bg-muted dark:hover:bg-white/[0.04] transition-colors group disabled:opacity-60"
              >
                {loadingId === report.id
