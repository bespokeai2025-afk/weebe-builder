      ...
      <div className="p-5 md:p-6 max-w-5xl space-y-6">
            ...
            {mapsError ? (
              ...
              <div className="space-y-1.5">
                {(mappings ?? []).map((m: any) => {
                  ...
                  return (
                    <div key={m.id} className="flex flex-wrap items-center gap-2 rounded-lg border border-border p-2.5 text-xs">
        ...
        <div className="rounded-xl border border-border bg-muted/40 p-4 space-y-3">
          ...
          {rulesError ? (
            ...
            <div className="space-y-1.5">
              {(rules ?? []).map((r: any) => (
                <div key={r.id} className="flex flex-wrap items-center gap-2 rounded-lg border border-border p-2.5 text-xs">
