  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {NAV_CARDS.map((c) => (
          <Link key={c.to} to={c.to} className="group rounded-xl border border-border bg-muted/40 p-4 hover:bg-muted hover:border-sky-500/30 transition-colors">
          ...
          <div className="space-y-1">
            {filtered.map((t: any) => (
              <button
                ...
                className={cn("w-full text-left rounded-lg border p-2.5 transition-colors", selected === t.id ? "border-sky-500/40 bg-sky-500/[0.08]" : "border-border bg-muted/40 hover:bg-muted")}
              >
          ...
          <div className="space-y-1 max-h-[70vh] overflow-y-auto">
            {filtered.slice(0, 300).map((n: any) => (
              <button
                ...
                className={cn("w-full text-left rounded-lg border p-2 transition-colors", selected === n.id ? "border-sky-500/40 bg-sky-500/[0.08]" : "border-border bg-muted/40 hover:bg-muted")}
              >
