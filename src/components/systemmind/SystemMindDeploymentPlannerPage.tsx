      ...
      <Section icon={Boxes} title={`Selected templates (${p.selected_templates.length})`}>
        <div className="space-y-1.5">
          {p.selected_templates.map((t) => (
            <div key={t.id} className="flex items-center justify-between gap-2 rounded border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] px-2.5 py-1.5">
    ...
    <SystemMindShell>
      <div className="p-5 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-4">
          {/* Composer + result */}
          <div className="space-y-3">
            <div className="rounded-xl border border-border dark:border-white/[0.06] bg-muted/20 dark:bg-white/[0.01] p-3">
              <Textarea
                value={request}
            ...
            {active ? (
              ...
              !genMut.isPending && (
                <div className="rounded-xl border border-border dark:border-white/[0.06] bg-muted/20 dark:bg-white/[0.01]">
                ...
                {plans.map((pl) => (
                  <div
                    ...
                    className={cn(
                      ...
                      active?.id === pl.id ? "border-sky-500/40 bg-sky-500/[0.08]" : "border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] hover:bg-muted dark:hover:bg-white/[0.04]",
                    )}
