...
const SEV_CLS: Record<string, string> = {
  ...
  low: "border-border dark:border-white/[0.1] text-muted-foreground",
};
...
function QueueTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      {items.map((it) => (
        <div key={it.id} className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-3 flex items-start justify-between gap-3">
...
function ImprovementsTab() {
  ...
  return (
    <div className="space-y-2">
      ...
      {items.map((it, i) => (
        <div key={i} className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-3 flex items-start gap-3">
