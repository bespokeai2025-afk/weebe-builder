...
function ProviderPriorityList({
  ...
  return (
    <div className="space-y-1.5 max-w-sm">
      {list.map((id, idx) => (
        <div key={id} className="flex items-center gap-2 rounded-lg border border-border bg-muted/40 px-3 py-2">
      ...
      <div className="mx-auto max-w-3xl px-4 py-6 md:px-8">
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {/* AI Persona */}
            <div className="rounded-xl border border-border bg-muted/40 px-5">
              ...
              <Row label="Error rate threshold" hint="Flag providers with an error rate above this percentage.">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-20 rounded-lg border border-border bg-muted/60 px-3 py-2 text-xs text-foreground focus:outline-none focus:ring-1 focus:ring-sky-500/50"
                  />
              ...
              <Row label="Daily cost threshold" hint="Alert if runtime cost exceeds this amount per day.">
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="w-24 rounded-lg border border-border bg-muted/60 px-3 py-2 text-xs text-foreground focus:outline-none focus:ring-1 focus:ring-sky-500/50"
                  />
