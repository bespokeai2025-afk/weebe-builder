...
function TaskCard({ task, onMove, onDelete, onEdit }: {
  ...
  return (
    <div
      ...
      className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-3 group cursor-grab active:cursor-grabbing active:opacity-60 transition-opacity"
    >
...
function EditModal({ task, onSave, onClose, saving }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-xl border border-border dark:border-white/[0.10] bg-[#0f1117] shadow-2xl">
        ...
        <div className="px-5 py-4 space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-border dark:border-white/[0.08] bg-muted/60 dark:bg-white/[0.03] px-3 py-2 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-sky-500/50"
            />
          </div>
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-border dark:border-white/[0.08] bg-muted/60 dark:bg-white/[0.03] px-3 py-2 text-xs text-foreground focus:outline-none focus:ring-1 focus:ring-sky-500/50"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-lg border border-border dark:border-white/[0.08] bg-muted/60 dark:bg-white/[0.03] px-3 py-2 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-sky-500/50"
            />
          </div>
          <div>
        ...
        <div className="flex items-center justify-end gap-2 px-5 py-4 border-t border-border dark:border-white/[0.06]">
            ...
            {COLUMNS.map((col) => {
              ...
              return (
                <div key={col.key} className="flex flex-col min-h-0">
                  ...
                  <div
                    className={cn(
                      "flex-1 overflow-y-auto space-y-2 rounded-xl border bg-muted/20 dark:bg-white/[0.01] p-2 transition-all",
                      isOver
                        ? `border-sky-500/40 bg-sky-500/[0.03] ring-1 ${col.dropColor}`
                        : "border-border/60 dark:border-white/[0.04]",
                    )}
                  ...
                  >
                    {items.length === 0 && (
                      <div className={cn(
                        ...
                        isOver ? "border-sky-500/30 text-sky-400/60" : "border-border/60 dark:border-white/[0.04] text-muted-foreground/40",
                      )}>
