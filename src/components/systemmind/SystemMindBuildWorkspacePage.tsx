  ...
  return (
    <Wrapper>
      ...
      <div className={embedded ? "flex h-[calc(100dvh-9.5rem)] min-h-0 gap-4 py-4" : "flex h-[calc(100dvh-3rem)] min-h-0 gap-4 p-4"}>
        ...
        {/* ── Main ── */}
        {!sessionId ? (
          <div className="flex min-h-0 flex-1 flex-col items-center gap-3 overflow-y-auto rounded-xl border border-border bg-muted/20 p-8 text-center [&>:first-child]:mt-auto [&>:last-child]:mb-auto">
            ...
            <div className="mt-2 w-full max-w-md space-y-2 rounded-xl border border-border bg-muted/40 p-4 text-left">
                ...
                <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2">
                  {(quickType && EXAMPLE_PROMPTS[quickType]
                    ...
                    <button
                      ...
                      className="rounded-lg border border-border bg-muted/40 px-3 py-2 text-left transition-colors hover:border-sky-500/30 hover:bg-sky-500/[0.06] disabled:opacity-50"
                    >
