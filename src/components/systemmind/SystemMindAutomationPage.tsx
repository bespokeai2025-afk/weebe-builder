        ...
        <div>
          ...
          <div className="space-y-2">
            {templates.map((t: any, i: number) => (
              <div key={i} className="rounded-lg border border-border dark:border-white/[0.05] bg-muted/40 dark:bg-white/[0.02] p-2.5">
      ...
      <div>
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <Badge variant="outline" className={cn(
            "text-[10px]",
            unconvertible.length > 0 ? "border-red-500/30 text-red-400" : "border-border dark:border-white/10 text-muted-foreground",
          )}>
...
function DraftCard({
  ...
  const sMeta = STATUS_META[draft.status] ?? { label: draft.status, color: "text-muted-foreground border-border dark:border-white/10" };
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.07] bg-muted/40 dark:bg-white/[0.02] overflow-hidden">
      ...
      {expanded && (
        <div className="border-t border-border dark:border-white/[0.06] bg-black/20 p-4 space-y-4">
          ...
          {customPrompt && (
            <div>
              ...
              <pre className="text-[11px] text-muted-foreground whitespace-pre-wrap bg-muted/40 dark:bg-white/[0.02] border border-border dark:border-white/[0.05] rounded-lg p-3 max-h-48 overflow-y-auto">{customPrompt}</pre>
            </div>
          )}
...
function AuditPanel({ draftId, onClose }: { draftId: string; onClose: () => void }) {
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.07] bg-muted/40 dark:bg-white/[0.02] p-4">
      ...
      {isLoading ? (
        ...
        <div className="space-y-2 max-h-72 overflow-y-auto">
          {rows.map((r: any) => (
            <div key={r.id} className="flex items-start gap-2 text-[11px] border-b border-border/60 dark:border-white/[0.04] pb-2 last:border-0">
      ...
      <div className="space-y-6">
        ...
        <div className={cn(
          ...
          claudeEnabled
            ...
            : "border-border dark:border-white/[0.08] bg-muted/60 dark:bg-white/[0.03] text-muted-foreground",
        )}>
        ...
        <div className="rounded-xl border border-border dark:border-white/[0.07] bg-muted/40 dark:bg-white/[0.02] p-4 space-y-3">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ...
                      : "border-border dark:border-white/[0.08] bg-muted/40 dark:bg-white/[0.02] text-muted-foreground hover:text-foreground hover:border-foreground/20 dark:hover:border-white/20",
                  )}
                >
          ...
          {mode === "whatsapp" && (
            <Select value={waProvider} onValueChange={(v) => setWaProvider(v as "twilio" | "wati" | "meta")}>
              <SelectTrigger className="w-56 h-8 text-xs bg-muted/40 dark:bg-white/[0.02] border-border dark:border-white/[0.08]">
          ...
          {mode === "n8n" ? (
            n8nLoading ? (
              ...
              <Select value={n8nRowId} onValueChange={setN8nRowId}>
                <SelectTrigger className="w-full h-9 text-xs bg-muted/40 dark:bg-white/[0.02] border-border dark:border-white/[0.08]">
            ...
            <Textarea
              ...
              className="min-h-[90px] text-sm bg-muted/40 dark:bg-white/[0.02] border-border dark:border-white/[0.08]"
              maxLength={4000}
            />
          )}
        ...
        <div className="space-y-3">
          ...
          {isLoading ? (
            ...
            <div className="rounded-xl border border-dashed border-border dark:border-white/[0.08] p-8 text-center">
