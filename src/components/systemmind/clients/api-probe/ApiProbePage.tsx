...
function Panel({ title, icon: Icon, children, accent = "sky" }: {
  ...
  return (
    <div className="rounded-xl border border-border bg-gray-900/40 overflow-hidden">
      <div className={cn("flex items-center gap-2 px-4 py-3 border-b border-border", ``)}>
  ...
  return (
    <div className="space-y-2">
      ...
      {(mappings as any[]).map((m: any) => (
        <div key={m.id} className="rounded-lg border border-border bg-gray-950/60 p-3">
          {editingId === m.id ? (
            <div className="space-y-2">
...
export function ApiProbePage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Page-level tabs */}
      <div className="flex gap-1 border-b border-border pb-px -mt-2">
        {([
            ...
            <button
              ...
              className={cn(
                ...
                selectedId === conn.id && !creatingNew
                  ...
                  : "border-border bg-gray-900/40 hover:border-foreground/20"
              )}
            >
