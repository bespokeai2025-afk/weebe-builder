...
function ModuleLogRow({ log }: { log: any }) {
  ...
  return (
    <div className="grid grid-cols-[1fr_80px_60px_70px_70px_80px] gap-2 items-center py-2 border-b border-border/60 last:border-0 text-xs">
...
function ProfileCard({ profile }: { profile: any }) {
  return (
    <div className="rounded-lg border border-border bg-gray-900/50 p-3 space-y-2">
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        {(status?.moduleLogs ?? []).length === 0 ? (
          ...
          <div className="rounded-lg border border-border bg-gray-900/40 overflow-hidden">
            <div className="grid grid-cols-[1fr_80px_60px_70px_70px_80px] gap-2 px-3 py-2 border-b border-border text-[10px] text-gray-500 uppercase tracking-wider">
