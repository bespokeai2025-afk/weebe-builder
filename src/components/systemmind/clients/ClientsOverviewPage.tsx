...
function StatCard({ label, value, icon: Icon, accent = "sky" }: {
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.06] bg-gray-900/40 p-4">
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        <Link
          ...
          className="group rounded-xl border border-border dark:border-white/[0.06] bg-gray-900/40 hover:border-sky-500/30 hover:bg-sky-500/[0.04] transition-all p-5 flex items-start gap-4"
        >
        ...
        <Link
          ...
          className="group rounded-xl border border-border dark:border-white/[0.06] bg-gray-900/40 hover:border-violet-500/30 hover:bg-violet-500/[0.04] transition-all p-5 flex items-start gap-4"
        >
      ...
      {conns.length > 0 && (
        <div>
          ...
          <div className="space-y-1.5">
            {conns.map((c: any) => (
              <div key={c.id} className="flex items-center gap-3 rounded-lg border border-border dark:border-white/[0.06] bg-gray-900/40 px-4 py-2.5">
