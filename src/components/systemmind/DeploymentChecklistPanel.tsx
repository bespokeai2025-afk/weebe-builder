...
export function DeploymentChecklistPanel({
  ...
  if (!deploymentId) {
    return (
      <div className="rounded-lg border border-border dark:border-white/[0.08] bg-card/60 p-4 space-y-2">
  ...
  return (
    <div className="rounded-lg border border-border dark:border-white/[0.08] bg-card/60 p-4 space-y-4" data-testid="deployment-checklist-panel">
      ...
      {needsTelephony && !telephonyBlocked && cl.deployment.status !== "live" && (
        <div className="rounded-md border border-border dark:border-white/[0.08] bg-muted/40 dark:bg-white/[0.02] p-3 space-y-3">
