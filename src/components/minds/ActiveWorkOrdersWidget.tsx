...
function MiniWorkOrderRow({ wo }: { wo: WorkOrderSummary }) {
  ...
  return (
    <Link
      ...
      params={{ id: wo.id }}
      className="flex items-start gap-3 px-4 py-3 hover:bg-muted/25 dark:hover:bg-white/[0.015] transition-colors group"
    >
      <div className={cn(
        ...
        <div className="flex items-center gap-2.5 mt-1 flex-wrap">
          {wo.stage_count > 0 && (
            <div className="flex items-center gap-1.5">
              <div className="h-1 w-14 rounded-full bg-muted dark:bg-white/[0.06] overflow-hidden">
                <div
...
export function ActiveWorkOrdersWidget({
  ...
  return (
    <div className={cn("rounded-xl border border-border dark:border-white/[0.06] bg-card/40 overflow-hidden", className)}>
