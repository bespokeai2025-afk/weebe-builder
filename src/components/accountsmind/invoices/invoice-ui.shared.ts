...
export const STATUS_STYLES: Record<string, string> = {
  ...
  ready: "bg-indigo-500/15 text-indigo-600 dark:text-indigo-300 border-indigo-500/30",
  unpaid: "bg-amber-500/15 text-amber-600 dark:text-amber-300 border-amber-500/30",
  sent: "bg-sky-500/15 text-sky-600 dark:text-sky-300 border-sky-500/30",
  viewed: "bg-cyan-500/15 text-cyan-600 dark:text-cyan-300 border-cyan-500/30",
  partially_paid: "bg-teal-500/15 text-teal-600 dark:text-teal-300 border-teal-500/30",
  paid: "bg-emerald-500/15 text-emerald-600 dark:text-emerald-300 border-emerald-500/30",
  overdue: "bg-red-500/15 text-red-600 dark:text-red-300 border-red-500/30",
  cancelled: "bg-slate-500/15 text-slate-600 dark:text-slate-400 border-slate-500/30",
  void: "bg-zinc-500/15 text-zinc-600 dark:text-zinc-400 border-zinc-500/30",
  refunded: "bg-purple-500/15 text-purple-600 dark:text-purple-300 border-purple-500/30",
};
