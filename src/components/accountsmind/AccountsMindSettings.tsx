    ...
    <div className="p-6 space-y-5">
      <div>
        <h1 className="text-xl font-bold text-foreground dark:text-white flex items-center gap-2">
          <Settings className="w-5 h-5 text-muted-foreground dark:text-gray-400" /> AccountsMind Settings
        </h1>
        <p className="text-sm text-muted-foreground dark:text-gray-400 mt-0.5">Configuration for the finance agent</p>
      </div>

      <div className="space-y-4">
        {/* Cost engine link */}
        <div className="bg-card border border-border dark:bg-gray-900 dark:border-gray-800 rounded-xl p-4">
          <div className="text-sm font-semibold text-foreground dark:text-white mb-1">Cost Engine</div>
        ...
        {/* Alert thresholds */}
        <div className="bg-card border border-border dark:bg-gray-900 dark:border-gray-800 rounded-xl p-4">
          <div className="text-sm font-semibold text-foreground dark:text-white mb-2">Alert Thresholds</div>
          <div className="space-y-2 text-xs text-muted-foreground dark:text-gray-400">
            <div className="flex justify-between py-1 border-b border-border/50 dark:border-gray-800/50">
          ...
          <p className="text-[10px] text-muted-foreground/70 dark:text-gray-600 mt-3">
        ...
        {/* Data sources */}
        <div className="bg-card border border-border dark:bg-gray-900 dark:border-gray-800 rounded-xl p-4">
          <div className="text-sm font-semibold text-foreground dark:text-white mb-2">Cost Data Sources</div>
          <div className="grid grid-cols-2 gap-1 text-xs text-muted-foreground dark:text-gray-400">
            {[
        ...
        <div className="bg-card border border-border dark:bg-gray-900 dark:border-gray-800 rounded-xl p-4">
          <div className="text-sm font-semibold text-foreground dark:text-white mb-1">HiveMind Integration</div>
