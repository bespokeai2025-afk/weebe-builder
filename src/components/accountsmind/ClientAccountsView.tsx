...
function IndustrySetupCard() {
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.07] bg-muted/20 dark:bg-white/[0.02] p-4 space-y-3">
  ...
  return (
    <div className="p-5 md:p-6 max-w-5xl mx-auto space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-border dark:border-white/[0.07] bg-muted/20 dark:bg-white/[0.02] p-6">
        ...
        <>
          {widgets.length > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {widgets.map((w: any) => {
                ...
                return (
                  <div key={w.id} className="rounded-xl border border-border dark:border-white/[0.07] bg-muted/20 dark:bg-white/[0.02] p-4">
          ...
          {stats.length > 0 && (
            <div className="rounded-xl border border-border dark:border-white/[0.07] bg-muted/20 dark:bg-white/[0.02] divide-y divide-border dark:divide-white/[0.05]">
              {stats.map((s: any) => (
