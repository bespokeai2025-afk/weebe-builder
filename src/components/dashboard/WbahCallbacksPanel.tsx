...
export function WbahCallbacksPanel({
  ...
  return (
    <div className="min-w-0">
      {/* Sub-tabs + search */}
      <div className="flex flex-col gap-2 border-b border-border dark:border-white/[0.06] px-2.5 py-2 sm:px-3">
              ...
              <button
                ...
                className={cn(
                  ...
                  active
                    ...
                    : "border-border dark:border-white/[0.06] bg-muted/20 text-muted-foreground hover:text-foreground",
                )}
              >
                {tab.label}
                {count > 0 && (
          ...
          <div className="ml-auto flex items-center gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="h-7 w-full min-w-[160px] max-w-[220px] rounded-md border border-border dark:border-white/[0.08] bg-muted/40 pl-7 pr-7 text-[11px] placeholder:text-muted-foreground/50 focus:outline-none focus:ring-1 focus:ring-primary/40 sm:w-52"
              />
              {search && (
                <button
                  type="button"
            ...
            <table className="w-full text-[11px]">
              ...
              <tbody>
                {rows.map((row) => (
                  <tr
                    key={row.id}
                    className="border-b border-border dark:border-white/[0.04] hover:bg-muted/20 dark:hover:bg-white/[0.02]"
                  >
