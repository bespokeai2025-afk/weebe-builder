...
export function WbahNewLeadSyncToggle({ active, className, onStateChange }: Props) {
  ...
  return (
    <div
      className={cn(
        "flex min-w-0 flex-col gap-0.5 rounded-lg border border-border dark:border-white/[0.08] bg-muted/20 dark:bg-white/[0.02] px-2.5 py-1.5 sm:flex-row sm:items-center sm:gap-3",
        className,
      )}
    >
