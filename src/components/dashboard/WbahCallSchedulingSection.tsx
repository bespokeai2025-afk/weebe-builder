    ...
    <div className="min-w-0 space-y-4">
      ...
      {campaignsQ.isLoading ? (
        ...
        <div className="space-y-3">
          {filtered.map((c) => (
            <div key={campaignId(c)} className="rounded-xl border border-border bg-card/60 p-4">
          ...
          <div className="overflow-y-auto flex-1 pr-1 space-y-4 pb-1">
            ...
            <div className="rounded-xl border border-border bg-card/40 p-4 space-y-3">
              ...
              <div>
                    ...
                    {leadStatusOptions.map((s) => {
                      ...
                      return (
                        <span
                          ...
                          className="inline-flex items-center gap-1 rounded-md border border-border bg-muted/60 px-2 py-0.5 text-[10px] text-muted-foreground"
                        >
                          {s.label}
                          {isTest && <WbahTestLeadBadge label="UAT" />}
                ...
                {leadStatusOptionsQ.isLoading ? (
                  <div className="mt-1 flex h-8 items-center gap-2 rounded-md border border-border px-3 text-xs text-muted-foreground">
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                    {scheduleWeekdays.map((d) => (
                      <label
                        key={d.value}
                        className="flex items-center gap-2 rounded-md border border-border px-2 py-1.5 text-[11px] cursor-pointer hover:bg-muted/60"
                      >
                        <Checkbox
