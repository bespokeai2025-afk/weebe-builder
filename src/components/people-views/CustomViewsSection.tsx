...
export function CustomViewsSection() {
  ...
  if (isLoading) {
    return (
      <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60 p-4 text-xs text-muted-foreground">
      ...
      <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60">
        ...
        {views.length === 0 ? (
          ...
          <div className="grid gap-2 p-3 sm:grid-cols-2 lg:grid-cols-3">
            {views.map((v) => (
              <div key={v.id} className="rounded-lg border border-border dark:border-white/[0.08] bg-muted/20 p-3">
                ...
                {historyFor === v.id && (
                  <div className="mt-2 rounded-md border border-border dark:border-white/[0.08] bg-black/20 p-2">
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60">
      <div className="flex items-center gap-2 border-b border-border dark:border-white/[0.06] px-3 py-2">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-border dark:border-white/[0.06] text-left text-[10px] uppercase tracking-wider text-muted-foreground">
          ...
          <tbody>
            {rows.length === 0 ? (
              ...
              rows.map((r) => (
                <tr key={r.id} className="border-b border-border/60 dark:border-white/[0.04]">
