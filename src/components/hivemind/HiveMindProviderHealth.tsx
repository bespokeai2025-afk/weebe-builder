    ...
    <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/40 overflow-hidden">
      ...
      {isLoading ? (
        ...
        <>
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    noneConnected ? "border-border/60 dark:border-white/[0.04] bg-muted/20 dark:bg-white/[0.01]" :
          ...
          {/* Footer */}
          <div className="border-t border-border dark:border-white/[0.06] px-4 py-2 flex items-center justify-between">
