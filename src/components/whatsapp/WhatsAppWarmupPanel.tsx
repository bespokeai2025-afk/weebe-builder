    ...
    <Card className="border-amber-500/20">
      ...
      <CardContent className="space-y-5">
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          <div className="rounded-lg border border-border dark:border-white/10 bg-muted/30 p-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              {phones.map((phone) => {
                ...
                return (
                  <div
                    key={phone}
                    className={`rounded-lg border p-3 ${enabled ? "border-emerald-500/30 bg-emerald-500/5" : "border-border dark:border-white/10 bg-muted/20 opacity-70"}`}
                  >
            ...
            {WATI_WARMUP_SCHEDULE.map((step) => {
              ...
              return (
                <div
                  ...
                  className={`rounded-lg border px-3 py-2 ${inTier ? "border-amber-500/40 bg-amber-500/10" : "border-border dark:border-white/10 bg-muted/20"}`}
                >
