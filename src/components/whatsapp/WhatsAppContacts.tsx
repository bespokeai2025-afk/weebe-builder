...
function ContactPersonPane({
  ...
  if (!contact) {
    return (
      <aside className="hidden h-full min-h-0 w-full flex-col border-l border-border dark:border-white/[0.06] bg-muted/20 lg:flex">
  ...
  return (
    <aside className="flex h-full min-h-0 w-full flex-col border-l border-border dark:border-white/[0.06] bg-muted/20">
      <div className="flex items-start gap-3 border-b border-border dark:border-white/[0.06] bg-card/80 px-4 py-4">
      ...
      <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-4 py-4">
        {stats ? (
          <section>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 rounded-lg border border-border dark:border-white/[0.06] bg-card/80 p-3 text-xs">
        ...
        {grouped.map((group) => (
          <section key={group.title}>
            ...
            <dl className="grid grid-cols-[minmax(0,38%)_1fr] gap-x-3 gap-y-1.5 rounded-lg border border-border dark:border-white/[0.06] bg-card/80 p-3 text-xs">
      ...
      <div className="grid shrink-0 grid-cols-2 gap-2 border-t border-border dark:border-white/[0.06] bg-card/80 p-3">
...
export function WhatsAppContacts() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-3">
      ...
      <div className="grid min-h-0 flex-1 overflow-hidden rounded-xl border border-border dark:border-white/[0.06] bg-card/60 lg:grid-cols-[minmax(0,1fr)_minmax(320px,400px)]">
          ...
          {isLoading ? (
            ...
            <div className="min-h-0 flex-1 overflow-auto">
              <table className="w-full text-sm">
                <thead className="sticky top-0 z-10 border-b border-border dark:border-white/[0.06] bg-muted/50">
                  <tr>
