    ...
    <div className="flex flex-col gap-6 p-6 max-w-4xl">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          ...
          <div key={m.label} className="rounded-xl border border-border bg-muted/40 p-4 flex flex-col gap-1">
      ...
      <div>
        ...
        {loadingEvents ? (
          <div className="flex flex-col gap-2">
            {[...Array(4)].map((_, i) => <div key={i} className="h-10 animate-pulse rounded-lg bg-muted/60" />)}
          </div>
        ) : events.length === 0 ? (
          <div className="rounded-xl border border-dashed border-border p-8 text-center flex flex-col items-center gap-2">
      ...
      {/* Webhook tip */}
      <div className="rounded-xl border border-border bg-blue-500/[0.03] p-4 flex items-start gap-3">
