            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {draft.kpis.map((kpi, i) => (
                  <span key={i} className="text-[11px] bg-muted text-muted-foreground px-2 py-1 rounded">
                    {kpi}
                  </span>
                ))}
              </div>
      ...
      <div className="px-6 py-5 max-w-3xl space-y-6">
        ...
        <div className="space-y-4">
          ...
          {isLoading ? (
            ...
            <div className="rounded-xl border border-dashed border-border bg-card/40 flex flex-col items-center justify-center py-12 gap-3">
