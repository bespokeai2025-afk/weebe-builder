...
function MetricCard({
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.08] bg-[hsl(var(--card))] px-4 py-4">
      <div className="flex items-center justify-between mb-3">
        <p className="text-[11px] text-muted-foreground font-medium uppercase tracking-wide">{label}</p>
        <div className={cn("flex h-7 w-7 items-center justify-center rounded-lg bg-muted dark:bg-white/[0.04]")}>
...
function RecommendationCard({
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.08] bg-[hsl(var(--card))] px-4 py-3 flex items-start gap-3">
      ...
      <div className="sticky top-0 z-20 border-b border-border dark:border-white/[0.07] bg-[hsl(var(--background))]/95 backdrop-blur-sm px-5 py-3 flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => refetch()} disabled={isFetching}
            className="flex items-center gap-1.5 rounded-lg border border-border dark:border-white/[0.08] bg-muted/60 dark:bg-white/[0.03] px-3 py-1.5 text-xs font-medium text-muted-foreground hover:text-foreground transition-all disabled:opacity-40">
      ...
      {isLoading ? (
        ...
        <div className="px-5 py-5 max-w-4xl space-y-6">
          ...
          {(d.today.leads + d.today.bookings + d.today.calls > 0) && (
            <div className="rounded-xl border border-border dark:border-white/[0.07] bg-[hsl(var(--card))] px-4 py-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {/* Top agent */}
            <div className="rounded-xl border border-border dark:border-white/[0.08] bg-[hsl(var(--card))] px-4 py-3">
          ...
          {d.agentRankings.length > 0 && (
            <div className="rounded-xl border border-border dark:border-white/[0.08] bg-[hsl(var(--card))] overflow-hidden">
