  ...
  return (
    <div className="flex h-full min-h-0 w-full">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeTab === item.id
                      ...
                      : "text-muted-foreground hover:bg-muted/30 dark:hover:bg-white/[0.04] hover:text-foreground",
                  )}
                >
      ...
      <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
        ...
        {/* Top bar */}
        <div className="border-b border-border dark:border-white/[0.06] px-6 py-3.5 flex items-center justify-between shrink-0">
          <div>
