      ...
      <div className="px-6 py-5 max-w-5xl">
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            {/* Summary bar */}
            <div className="flex items-center gap-4 rounded-xl border border-border dark:border-white/[0.06] bg-card/60 px-5 py-4 flex-wrap">
              <div>
              ...
              <div className="flex-1 h-2 rounded-full bg-muted dark:bg-white/[0.06] overflow-hidden min-w-[100px]">
                <div
              ...
              <div>
                ...
                <div className="rounded-xl border border-border dark:border-white/[0.06] overflow-hidden">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-border dark:border-white/[0.06] bg-muted/25 dark:bg-white/[0.015]">
