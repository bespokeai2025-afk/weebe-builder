...
function ConfidenceBar({ score, source }: { score: number; source?: string }) {
  ...
  return (
    <div className="flex items-center gap-2 min-w-0">
      <div className="flex-1 h-1.5 rounded-full bg-muted overflow-hidden" style={{ minWidth: 60 }}>
...
function DnaField({
  ...
  return (
    <div className="group border border-border rounded-xl bg-muted/40 p-3 hover:bg-muted/60 transition-colors">
      ...
      {editing ? (
        <div className="space-y-1.5">
          {multiline ? (
            <textarea
              autoFocus
              className="w-full bg-muted border border-violet-500/30 rounded-lg px-2.5 py-1.5 text-xs text-foreground focus:outline-none focus:border-violet-500/60 resize-none"
              rows={3}
              value={draft}
            ...
            <input
              ...
              className="w-full bg-muted border border-violet-500/30 rounded-lg px-2.5 py-1.5 text-xs text-foreground focus:outline-none focus:border-violet-500/60"
              value={draft}
              onChange={e => setDraft(e.target.value)}
...
function DnaSection({
  ...
  return (
    <div className="rounded-2xl border border-border bg-[hsl(var(--card))] overflow-hidden">
      <button
        onClick={() => setOpen(o => !o)}
  ...
  return (
    <HiveMindShell>
      <div className="p-5 md:p-7 max-w-5xl mx-auto space-y-6">
        ...
        {/* Stats row */}
        <div className="flex items-center gap-6 rounded-2xl border border-border bg-[hsl(var(--card))] px-6 py-5">
