            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg border border-border bg-muted/60 px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/40 focus:outline-none focus:ring-1 focus:ring-violet-500/40"
                />
                <button
                  onClick={saveName}
                  className={cn(
            ...
            {OPERATOR_CLASS_MODES.includes(mode) && (
              <div className="mt-3 rounded-lg border border-amber-500/20 bg-amber-500/[0.04] overflow-hidden">
                ...
                {(modeData?.operatorEnabledBy || modeData?.operatorEnabledAt) && (
                  <div className="px-3.5 py-2 border-t border-amber-500/10 bg-muted/20">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between py-1 border-t border-border">
              ...
              <button
                ...
                className={cn("w-9 h-5 rounded-full relative transition-all", voiceSettings.autoPlay ? "bg-violet-500" : "bg-muted")}
              >
