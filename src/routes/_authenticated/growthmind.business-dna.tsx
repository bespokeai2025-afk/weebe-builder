...
function Section({ title, description, children, id, open, onToggle }: {
  ...
  return (
    <div className="rounded-xl border border-border bg-card/60 overflow-hidden">
      ...
      {open && <div className="px-5 pb-5 grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-border/60 pt-4">{children}</div>}
    </div>
  );
}
      ...
      <form onSubmit={handleSave} className="px-6 py-5 max-w-3xl space-y-5">
        ...
        {proposals.length > 0 && (
          <div className="rounded-xl border border-emerald-500/25 bg-emerald-500/[0.05] p-4 space-y-3">
            ...
            {proposals.map((p: any) => (
              <div key={p.id} className="rounded-lg border border-border bg-card/60 p-3 space-y-2">
        ...
        <div className="rounded-xl border border-border bg-card/60 overflow-hidden">
          ...
          {showHistory && (
            <div className="px-5 pb-4 border-t border-border/60 pt-3 space-y-1.5">
