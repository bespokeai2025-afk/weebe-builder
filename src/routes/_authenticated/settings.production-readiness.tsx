...
function EnvRow({ k, present, required }: { k: string; present: boolean; required: boolean }) {
  return (
    <div className="flex items-center justify-between py-1.5 border-b border-border dark:border-white/[0.04] last:border-0">
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-xs">
              {[
                ...
                <div key={row.label} className="flex items-center justify-between gap-4 py-1 border-b border-border dark:border-white/[0.04] last:border-0">
                  <span className="text-muted-foreground w-36 shrink-0">{row.label}</span>
                  <code className="font-mono text-[11px] bg-muted/30 dark:bg-white/[0.04] px-2 py-0.5 rounded">{row.value}</code>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {data.webhooks.map(w => (
                <div key={w.id} className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/20 dark:bg-white/[0.02] p-3">
          ...
          <Card>
            ...
            <CardContent className="p-0">
              <Accordion type="multiple" className="w-full">
                ...
                {/* Supabase */}
                <AccordionItem value="supabase" className="border-b border-border dark:border-white/[0.05] px-6">
                  ...
                  <AccordionContent className="pb-3 space-y-2 text-[11px]">
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-center justify-between rounded bg-muted/20 dark:bg-white/[0.03] border border-border dark:border-white/[0.06] px-2.5 py-1.5">
                ...
                {/* DNS */}
                <AccordionItem value="dns" className="border-b border-border dark:border-white/[0.05] px-6">
                  <AccordionTrigger className="text-xs py-3 hover:no-underline">
                    <span className="flex items-center gap-2">
                  ...
                  <AccordionContent className="pb-3 space-y-2 text-[11px]">
                    ...
                    <div className="rounded bg-muted/20 dark:bg-white/[0.03] border border-border dark:border-white/[0.06] p-3 space-y-1.5 font-mono text-[10px]">
                      ...
                      <div className="mt-1 border-t border-border dark:border-white/[0.06] pt-1">
                ...
                {/* Stripe */}
                <AccordionItem value="stripe" className="border-b border-border dark:border-white/[0.05] px-6">
                  <AccordionTrigger className="text-xs py-3 hover:no-underline">
                    <span className="flex items-center gap-2">
                  ...
                  <AccordionContent className="pb-3 space-y-2 text-[11px]">
                    ...
                    <div className="flex items-center rounded bg-muted/20 dark:bg-white/[0.03] border border-border dark:border-white/[0.06] px-2.5 py-1.5">
                ...
                {/* Meta WhatsApp */}
                <AccordionItem value="meta" className="border-b border-border dark:border-white/[0.05] px-6">
                  <AccordionTrigger className="text-xs py-3 hover:no-underline">
                    <span className="flex items-center gap-2">
                ...
                <AccordionItem value="frejun" className="px-6">
                  ...
                  <AccordionContent className="pb-3 space-y-2 text-[11px]">
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-center rounded bg-muted/20 dark:bg-white/[0.03] border border-border dark:border-white/[0.06] px-2.5 py-1.5">
            ...
            <Card>
              ...
              <CardContent className="space-y-1.5">
                {(expandedLog ? updateLog : updateLog.slice(0, 5)).map((row: any) => (
                  <div key={row.id} className="flex items-center gap-3 text-[10px] rounded bg-muted/20 dark:bg-white/[0.02] border border-border dark:border-white/[0.04] px-2.5 py-1.5">
                    <span className={cn(
