...
function WbahLeadsSection() {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* Filter panel */}
      {showFilters && (
        <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/50 px-4 py-3 flex flex-wrap gap-x-8 gap-y-3">
              ...
              <div className="flex flex-col gap-1 max-h-36 overflow-y-auto pr-1">
                {uniqueStatuses.map(s => (
                  <label key={s} className="flex items-center gap-2 cursor-pointer select-none group">
                    ...
                    <span className={cn(
                      "flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded border border-border dark:border-white/20 transition-colors",
                      statusFilters.has(s) ? "bg-primary border-primary" : "bg-transparent group-hover:border-foreground/30 dark:hover:border-white/40",
                    )}>
            ...
            <div className="flex flex-col gap-1">
              {SENTIMENTS.map(s => (
                <label key={s} className="flex items-center gap-2 cursor-pointer select-none group">
                  ...
                  <span className={cn(
                    "flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded border border-border dark:border-white/20 transition-colors",
                    sentFilters.has(s) ? "bg-primary border-primary" : "bg-transparent group-hover:border-foreground/30 dark:hover:border-white/40",
                  )}>
              ...
              <div className="flex flex-col gap-1 max-h-36 overflow-y-auto pr-1">
                {uniqueAgents.map(agent => (
                  <label key={agent} className="flex items-center gap-2 cursor-pointer select-none group">
                    ...
                    <span className={cn(
                      "flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded border border-border dark:border-white/20 transition-colors",
                      agentFilters.has(agent) ? "bg-primary border-primary" : "bg-transparent group-hover:border-foreground/30 dark:hover:border-white/40",
                    )}>
      ...
      {/* Table */}
      <div className={cn("rounded-xl border border-border dark:border-white/[0.06] bg-card/60 overflow-hidden transition-opacity", isFetching && "opacity-60")}>
        {filtered.length === 0 ? (
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                {leadsPag.sliced.map((r: any, idx: number) => (
                  <tr key={r.id ?? idx} className="h-9 border-b border-border/60 dark:border-white/[0.04] last:border-0 align-middle hover:bg-muted/40 dark:hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="px-3 py-1.5">
                      <button onClick={() => setViewRecord(r)} className="inline-flex items-center gap-1 text-[11px] rounded border border-border dark:border-white/20 px-2 py-0.5 text-muted-foreground hover:text-foreground hover:border-foreground/30 dark:hover:border-white/40 whitespace-nowrap transition-colors">
                        View
                      </button>
                    </td>
      ...
      {activeTab === "contacts" && (
        <>
          ...
          <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60 overflow-hidden">
            {/* Toolbar */}
            <div className="flex items-center gap-2 px-4 py-2.5 border-b border-border dark:border-white/[0.06]">
                ...
                <table className="w-full text-xs">
                  ...
                  <tbody>
                    {contactsPag.sliced.map((r: any) => (
                      <tr
                        key={r.id}
                        className="h-9 border-b border-border/60 dark:border-white/[0.04] last:border-0 align-middle hover:bg-muted/40 dark:hover:bg-white/[0.02] transition-colors"
                      >
