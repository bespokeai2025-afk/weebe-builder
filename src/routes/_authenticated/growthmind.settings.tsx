  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
            ...
            return (
              <button key={key} type="button" disabled={saving}
                ...
                className={cn(
                  ...
                  active ? "border-emerald-500/50 bg-emerald-500/[0.08]" : "border-border dark:border-white/[0.06] bg-background/40 hover:bg-muted/60 dark:hover:bg-white/[0.03]",
                )}>
      ...
      <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60 p-5 space-y-4">
        ...
        <div className="rounded-lg border border-border dark:border-white/[0.06] bg-background/40 p-4 space-y-3">
          <div>
          ...
          {rules.restricted_terms.length === 0 ? (
            ...
            <div className="flex flex-wrap gap-1.5">
              {rules.restricted_terms.map((term) => (
                <span key={term} className="inline-flex items-center gap-1 rounded-full border border-border dark:border-white/[0.08] bg-muted dark:bg-white/[0.04] px-2.5 py-1 text-[11px]">
                  {term}
                  <button
                    type="button"
                    disabled={savingRules}
      ...
      {/* Activity log */}
      <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60 p-5 space-y-3">
        <div className="flex items-center gap-2">
        ...
        <div className="space-y-1.5">
          {entries.map((e: any) => (
            <div key={e.id} className="flex items-center justify-between gap-3 text-xs py-1 border-b border-border/50 dark:border-white/[0.03] last:border-0">
