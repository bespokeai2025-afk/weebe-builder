...
function HeroStats({ data }: { data: AdsPerformanceData }) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
      {stats.map(s => (
        <div key={s.label} className="rounded-xl border border-border dark:border-white/[0.06] bg-card/40 p-3.5 space-y-1.5">
...
function SyncHistoryPanel() {
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/40">
      <button
        className="w-full flex items-center gap-2 px-5 py-3.5 text-left hover:bg-muted/40 dark:hover:bg-white/[0.02] transition-colors"
        onClick={() => setOpen(o => !o)}
      >
          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs">
                ...
                <tbody>
                  {rows.map(r => (
                    <tr key={r.id} className="border-b border-border/50 dark:border-white/[0.03] hover:bg-muted/40 dark:hover:bg-white/[0.02] transition-colors">
...
function BudgetCapsPanel({ hasAnyCap }: { hasAnyCap: boolean }) {
  ...
  return (
    <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/40">
      ...
      {open && (
        <div className="border-t border-border dark:border-white/[0.06] px-5 pb-5 pt-4 space-y-5">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {PLATFORM_CAP_CONFIG.map(({ platform, label, color }) => {
                const draft = getDraft(platform);
                return (
                  <div key={platform} className="rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-4 space-y-3">
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 rounded-lg border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-0.5">
      ...
      {isLoading ? (
        <div className="flex items-center justify-center h-40 rounded-xl border border-border dark:border-white/[0.06] bg-card/40">
          <Loader2 className="h-5 w-5 animate-spin text-muted-foreground/40" />
        </div>
      ) : !hasAnyData ? (
        <div className="flex flex-col items-center justify-center h-40 rounded-xl border border-dashed border-border dark:border-white/[0.08] text-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {CHART_PANELS.map(panel => {
            ...
            return (
              <div key={panel.key} className="rounded-xl border border-border dark:border-white/[0.06] bg-card/40 p-4 space-y-3">
      ...
      <div className="space-y-3">
        {items.map(item => (
          <div key={item.label} className="space-y-1.5">
            ...
            <div className="h-2 w-full rounded-full bg-muted dark:bg-white/[0.05] overflow-hidden">
              <div
...
function BudgetUtilizationBar({
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="relative h-2 w-full rounded-full bg-muted dark:bg-white/[0.05] overflow-hidden">
        <div
        ...
        {alertPct < 100 && (
          <div
            className="absolute top-0 bottom-0 w-px bg-muted dark:bg-white/20"
            style={{ left: `${alertPct}%` }}
...
function PlatformCard({
  ...
  if (!hasCreds) {
    return (
      <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/40 p-5 flex flex-col gap-3">
        <div className="flex items-center gap-2">
          {logo}
...
function Metric({
  ...
  return (
    <div className="rounded-lg bg-muted/60 dark:bg-white/[0.03] border border-border/60 dark:border-white/[0.04] p-2.5">
...
function CampaignRow({ c }: { c: AdCampaign }) {
  ...
  return (
    <tr className="border-b border-border/60 dark:border-white/[0.04] hover:bg-muted/40 dark:hover:bg-white/[0.02] transition-colors">
    ...
    <GrowthMindShell>
      <div className="px-6 py-5 max-w-6xl space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {data?.syncHealth && (() => {
              ...
              return (
                <div className="flex items-center gap-1.5 rounded-lg border border-border dark:border-white/[0.07] bg-muted/40 dark:bg-white/[0.02] px-2.5 py-1.5">
                  ...
                  {h.lastSyncedAt && (
                    <>
                      <span className="h-2.5 w-px bg-muted dark:bg-white/10 shrink-0" />
            ...
            <Button
              ...
              className="h-8 gap-1.5 text-xs border-border dark:border-white/[0.08]"
            >
        ...
        {!isLoading && !hasAnyCreds && (
          <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/60 p-8 text-center space-y-3">
          ...
          <>
            ...
            {campaigns.length > 0 && (
              <div className="space-y-2">
                ...
                <div className="rounded-xl border border-border dark:border-white/[0.06] bg-card/40 overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full text-xs">
                      <thead>
                      ...
                      {/* Totals row */}
                      <tfoot>
                        <tr className="border-t border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02]">
            ...
            {/* No campaigns yet */}
            {campaigns.length === 0 && (
              <div className="rounded-xl border border-dashed border-border dark:border-white/[0.1] p-8 text-center space-y-2">
            ...
            {!(data?.hasMetaCreds && data?.hasGoogleCreds) && (
              <div className="rounded-xl border border-border dark:border-white/[0.06] bg-muted/40 dark:bg-white/[0.02] p-4 flex items-center gap-3">
                ...
                <Link to="/settings/providers">
                  <Button size="sm" variant="outline" className="text-xs border-border dark:border-white/[0.08] gap-1">
