      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-5 md:py-7">
        ...
        <div className="mb-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {/* Voice engine filter */}
            <div className="flex items-center rounded-lg bg-muted/30 dark:bg-white/[0.03] p-0.5 ring-1 ring-border dark:ring-white/[0.06]">
              {(
                [
                  { value: "ALL", label: "All" },
                  { value: "RETELL", label: "OmniVoice", icon: <Radio className="h-3 w-3 text-sky-600 dark:text-sky-400" /> },
                  { value: "OPENAI_REALTIME", label: "HyperStream", icon: <Zap className="h-3 w-3 text-violet-600 dark:text-violet-400" /> },
                ] as const
                ...
                <button
                  ...
                  className={`inline-flex h-7 items-center gap-1.5 rounded-md px-2.5 text-[11px] font-medium transition-all ${
                    voiceFilter === value
                      ? "bg-muted dark:bg-white/[0.08] text-foreground shadow-sm ring-1 ring-border dark:ring-white/[0.10]"
                ...
                >
                  ...
                  {value !== "ALL" && (
                    <span className={`rounded px-1 py-px text-[10px] font-semibold tabular-nums leading-none ${
                      voiceFilter === value
                        ? "bg-muted dark:bg-white/[0.10] text-foreground"
                        : "bg-muted/40 dark:bg-white/[0.05] text-muted-foreground"
                    }`}>
                      {engineCounts[value]}
                    </span>
                  )}
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="h-9 w-56 border-border dark:border-white/[0.06] bg-muted/20 dark:bg-white/[0.02] pl-8 text-sm"
              />
            </div>
        ...
        {agentsQ.isLoading ? (
          ...
          <div className="rounded-xl bg-card/60 p-8 text-center ring-1 ring-border dark:ring-white/[0.06]">
          ...
          <div className="rounded-2xl bg-card/60 p-10 text-center ring-1 ring-border dark:ring-white/[0.06] text-sm text-muted-foreground">
