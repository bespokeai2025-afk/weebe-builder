          ...
          sections: [
            {
              ...
              children: [
                ...
                p(""),
                p("[BOOKING — schedule a free solar assessment with the local advisor team]", true),
                p(""),

                h2("STEP 8: Confirm Details"),
                p("Perfect! I've got you booked in. Just to confirm — your name is [full name], and the address is [address]?"),
                p("(pause)", false, true),
                p("And the best number to reach you on is [phone number]?"),
                p(""),
