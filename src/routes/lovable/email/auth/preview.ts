...
// Configuration
const SITE_NAME = process.env.SITE_NAME ?? "webespokegenbuilder";
const ROOT_DOMAIN = "webespokeaibuilder.com";
...
const SAMPLE_PROJECT_URL = process.env.PUBLIC_SITE_URL ?? "https://webespokegenbuilder.lovable.app";
