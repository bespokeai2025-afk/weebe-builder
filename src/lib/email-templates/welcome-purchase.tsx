  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We're getting your account ready. You'll receive a follow-up email shortly with the link
          to your dashboard and next steps for getting your AI agent up and running.
        </Text>
        <Text style={text}>
