...
GRANT SELECT, INSERT, UPDATE, DELETE ON webform_sources     TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON webform_submissions TO authenticated;
GRANT ALL ON webform_sources     TO service_role;
GRANT ALL ON webform_submissions TO service_role;
GRANT ALL ON webform_rate_limits TO service_role;


-- ============================================================
-- Migration: 20260717000003_custom_agent_configs
-- ============================================================
