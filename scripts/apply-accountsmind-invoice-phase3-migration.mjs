 ...
 * Run: node scripts/apply-accountsmind-invoice-phase3-migration.mjs
...
const SQL = readFileSync(
  resolve(__dir, "../supabase/migrations/20260723130000_accountsmind_invoice_phase3.sql"),
  "utf8",
);
...
if (projectRef && mgmtToken) {
  ...
  try {
    ...
    console.warn("[invoice-phase3-migration] Management API error:", JSON.stringify(json));
  } catch (err) {
    console.warn("[invoice-phase3-migration] Management API network error:", err?.message);
  }
}
