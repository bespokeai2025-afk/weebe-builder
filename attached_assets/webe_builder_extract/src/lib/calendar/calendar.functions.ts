...
/** Get the current user's workspace calendar settings (or null if none). */
...
export const saveWorkspaceCalendarSettings = createServerFn({ method: "POST" })
  ...
  .handler(async ({ context, data }) => {
    ...
    if (data.defaultEventTypeId !== undefined) patch.default_event_type_id = data.defaultEventTypeId;
