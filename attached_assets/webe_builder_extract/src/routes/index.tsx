  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Webespoke AI — Visual Voice Agent Builder" },
      {
        ...
        content:
          "Drag, connect, and deploy a Webespoke AI voice agent for your call script.",
      },
      { property: "og:url", content: "https://www.webespokeai.com" },
      { property: "og:type", content: "website" },
    ],
    links: [
      { rel: "canonical", href: "https://www.webespokeai.com" },
    ],
  }),
  component: Index,
});
        ...
        <div className="mx-auto max-w-7xl px-4 py-16">
          <div className="text-center mb-8">
            ...
            <p className="mt-3 text-sm text-muted-foreground max-w-2xl mx-auto">
              Drag, connect, and fill in your call flow. Works on desktop and mobile.
              Deploy your Webespoke AI agent when you're ready.
            </p>
          </div>
          {authed ? (
            <Builder />
