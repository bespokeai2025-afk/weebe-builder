...
import {
  listUserActivity,
  setUserReviewed,
} from "@/lib/admin/user-activity.functions";
...
function UserActivityPage() {
  ...
  const reviewMutation = useMutation({
    mutationFn: (vars: { profileId: string; reviewed: boolean }) =>
      setReviewed({ data: vars }),
    onSuccess: (_d, vars) => {
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-5xl px-4 py-6 space-y-6">
        <p className="text-sm text-muted-foreground">
          Track new signups and every email sent to them. Mark a user as reviewed
          once you've seen their interaction.
        </p>
