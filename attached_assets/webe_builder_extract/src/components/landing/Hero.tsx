    ...
    <section className="relative overflow-hidden border-b bg-gradient-to-b from-background to-muted/30">
      ...
      <div className="mx-auto max-w-5xl px-6 py-20 md:py-28 text-center">
        ...
        <p className="mt-5 mx-auto max-w-2xl text-base md:text-lg text-muted-foreground">
          Lay out your call structure, transitions, and dialogue visually —
          then deploy your Webespoke AI agent in one click.
        </p>
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Button asChild size="lg">
            <a href="#tool-section">Start Building <ArrowRight className="h-4 w-4 ml-1" /></a>
          </Button>
          <Button asChild size="lg" variant="outline">
            <a href="#how-it-works">How It Works</a>
          </Button>
          <Button asChild size="lg" variant="ghost">
            <Link to="/builder">Open full builder</Link>
          </Button>
        </div>
      </div>
    </section>
