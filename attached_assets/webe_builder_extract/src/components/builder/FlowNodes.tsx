...
const STYLES: Record<NodeKind, Style> = {
  ...
  function: {
    ...
    ringClass: "!ring-2 !ring-violet-500/70 !border-violet-500/70 shadow-[0_0_24px_-4px_rgba(139,92,246,0.55)] dark:shadow-[0_0_28px_-4px_rgba(167,139,250,0.6)]",
  },
  call_transfer: {
    badge: "Call Transfer",
  ...
  return (
    <div className="relative group">
      ...
      <div className={cn(
        ...
        isActive && "!ring-4 !ring-emerald-500 !border-emerald-500 shadow-[0_0_40px_-2px_rgba(52,211,153,0.5)] animate-pulse",
      )}>
        {/* Header */}
  ...
  return (
    <div className="relative group">
      <div className={cn(
        ...
        !isActive && style.ringClass,
        isActive && "ring-4 ring-emerald-400 border-emerald-400 shadow-[0_0_30px_-2px_rgba(52,211,153,0.7)] animate-pulse",
      )}>
        <div className={cn("relative rounded-t-xl border-b px-3 py-2", style.headerClass)}>
          {!isNote && (
            <Handle
...
export const NodeRenderers: Record<NodeKind, typeof ConversationStyleNode> = {
  ...
  extract_variable: ConversationStyleNode,
