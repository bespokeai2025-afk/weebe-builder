...
export function Builder({
  ...
  const { addNode, addBookingNode, clearAll, autoLayout, revertLayout, settings, setSettings } = useBuilderStore();
      ...
      <div className="flex flex-1 min-h-0">
            ...
            <div className="flex border-b border-white/[0.04] text-[10px] uppercase tracking-wider">
              <button
                className={cn(
                  ...
                  tab === "node" ? "bg-white/[0.04] text-foreground" : "text-muted-foreground hover:text-foreground",
                )}
                onClick={() => setTab("node")}
              >
                Node
              ...
              <button
                className={cn(
                  "flex-1 py-1.5 font-medium transition-colors",
                  tab === "components" ? "bg-white/[0.04] text-foreground" : "text-muted-foreground hover:text-foreground",
                )}
        ...
        {rightOpen && (
          <aside className="w-60 shrink-0 border-l border-white/[0.04] bg-background/40 overflow-y-auto p-2 space-y-2 hidden md:block text-xs [&_label]:text-[10px] [&_label]:uppercase [&_label]:tracking-wider [&_label]:text-muted-foreground [&_textarea]:text-[11px] [&_button[role=combobox]]:h-7 [&_button[role=combobox]]:text-[11px]">
            <h3 className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">Global Settings</h3>
