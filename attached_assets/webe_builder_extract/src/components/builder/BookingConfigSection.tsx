...
import { listCalcomEventTypes, getWorkspaceCalendarSettings } from "@/lib/calendar/calendar.functions";
    ...
    <Collapsible className="rounded-lg border" defaultOpen>
      ...
      <CollapsibleContent className="space-y-3 px-2 pb-3">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <Switch
            checked={enabled}
            onCheckedChange={(v) => updateBooking({ enabled: v })}
          />
        </div>
          ...
          >
            ...
            <SelectContent>
              ...
              {eventTypes.map((et) => (
                <SelectItem
                  key={et.id}
                  value={String(et.calcom_event_type_id)}
                >
