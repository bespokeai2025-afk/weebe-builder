...
- The Analytics Centre "Paid Ads" tab hit this exact trap (July 2026): it read only legacy growthmind_ad_campaigns and showed "No ad data synced yet" despite a healthy sync. Any surface showing paid Google metrics must merge getGadsLiveCampaignSummary/getGoogleAccountRow (workspace-scoped) and show honest connected/needs_reconnect/no-data states — never silent zeros.
